...
const ModalRegistroEmpleado = ({
  ...
  const [confirmarContrasenaValida, setConfirmarContraseñaValida] =
    useState(false);
  ...
  const validarCorreo = (valor) => {
    ...
    if (!emailRegex.test(valor))
      return "El correo debe tener un formato válido (usuario@dominio.com).";
    return "";
  };
  ...
  const validarTelefono = (valor) => {
    ...
    if (!telefonoRegex.test(valor))
      return "El teléfono debe seguir el formato xxxx-xxxx. ";
    return "";
  };
  ...
  const isFormValid = () => {
    return (
      ...
      validarConfirmarContraseña(
        nuevoEmpleado.confirmarContraseña,
